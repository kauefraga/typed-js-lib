# Typed Javascript Library [![version](https://badgen.net/npm/v/typed-js-lib)](https://npm.im/typed-js-lib) [![install size](https://packagephobia.com/badge?p=typed-js-lib)](https://packagephobia.com/result?p=typed-js-lib)
